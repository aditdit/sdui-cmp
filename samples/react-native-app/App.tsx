...
import { SduiView, getPlatformName } from 'react-native-sdui';
...
function App() {
  ...
  React.useEffect(() => {
    getPlatformName().then(setPlatform).catch((err: any) => setPlatform('Error: ' + err.message));
  }, []);
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>SDUI Sample App</Text>
          <Text style={{ color: '#666' }}>Platform: {platform}</Text>
        </View>
        <SduiView
          sduiJson={mockSduiData}
